...
class Parser
{
	...
	void Operations(){
		tree.down("<ÎÏÅĞÀÖÈÈ>", stream.getCurrentElement());
	...
	void Operation() {
		tree.down("<ÎÏÅĞÀÖÈß>", stream.getCurrentElement());
	...
	void LogicExpression() {
		tree.down("<ËÎÃÈ×ÅÑÊÀß ÎÏÅĞÀÖÈß>", stream.getCurrentElement());
	...
	void VariableDefine() {
		tree.down("<ÎÁÚßÂËÅÍÈÅ ÏÅĞÅÌÅÍÍÎÉ>", stream.getCurrentElement());
	...
	void AcceptedArguments() {
		tree.down("<ÏÎÑËÅÄ. ÏĞÈÍ. ÀĞÃÓÌÅÍÒÎÂ>", stream.getCurrentElement());
	...
	void Return() {
		tree.down("<ÂÎÇÂĞÀÒ>", stream.getCurrentElement());
	...
	void Assignment() {
		tree.down("<ÏĞÈÑÂÎÅÍÈÅ>", stream.getCurrentElement());
	...
	void Operand() {
		tree.down("<ÎÏÅĞÀÍÄ>", stream.getCurrentElement());
	...
	void PassedArguments() {
		tree.down("<ÏÎÑËÅÄ. ÏÅĞÅÄ. ÀĞÃÓÌÅÍÒÎÂ>", stream.getCurrentElement());
